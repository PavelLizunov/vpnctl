...
- **Total Rust LOC:** 119,798 (77,868 prod / 41,930 test)
...
| `vpnctl-protocols` | `crates/protocols` | 0.9.0 | lib, 10 tests | 4,105 (17) | 3,759 (10) | **7,864** |
...
| **Total** | | | | **77,868 (230)** | **41,930 (97)** | **119,798** |
