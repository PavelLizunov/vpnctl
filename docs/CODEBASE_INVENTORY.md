...
- **Total Rust LOC:** 124,897 (81,700 prod / 43,197 test)
...
| `vpnctl-inventory` | `crates/inventory` | 0.9.0 | lib, 33 tests | 13,255 (48) | 13,876 (37) | **27,131** |
...
| **Total** | | | | **81,700 (234)** | **43,197 (98)** | **124,897** |
