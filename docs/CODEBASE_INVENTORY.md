...
- **Workspace Crates:** 10
- **Tracked Rust Files:** 397 (269 prod / 128 test)
- **Total Rust LOC:** 142,190 (85,975 prod / 56,215 test)
...
| `vpnctld` | `daemon` | 0.9.0 | lib, bin, 9 tests | 48,491 (142) | 29,880 (55) | **78,371** |
| **Total** | | | | **85,975 (269)** | **56,215 (128)** | **142,190** |
