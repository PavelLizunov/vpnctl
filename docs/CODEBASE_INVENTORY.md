...
- **Total Rust LOC:** 122,097 (79,431 prod / 42,666 test)
...
| `vpnctl-inventory` | `crates/inventory` | 0.9.0 | lib, 32 tests | 13,038 (46) | 13,427 (36) | **26,465** |
...
| **Total** | | | | **79,431 (231)** | **42,666 (97)** | **122,097** |
