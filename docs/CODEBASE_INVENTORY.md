...
- **Workspace Crates:** 10
- **Tracked Rust Files:** 359 (243 prod / 116 test)
- **Total Rust LOC:** 136,637 (85,538 prod / 51,099 test)
...
| `vpnctld` | `daemon` | 0.9.0 | lib, bin, 9 tests | 47,536 (127) | 28,477 (52) | **76,013** |
| **Total** | | | | **85,538 (243)** | **51,099 (116)** | **136,637** |
