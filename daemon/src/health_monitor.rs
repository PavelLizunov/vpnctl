...
impl Remediation {
    ...
    fn recovery_kind(self) -> &'static str {
        match self {
    ...
    fn verified_by(self, probe: &crate::node_probe::Probe) -> bool {
        match self {
    ...
    fn recovery_payload(self, probe: &crate::node_probe::Probe) -> serde_json::Value {
        match self {
